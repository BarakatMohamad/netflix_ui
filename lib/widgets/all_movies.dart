...
class TopRated extends StatelessWidget {
  ...
  const TopRated({Key? key, required this.topRated, required this.name})
      : super(key: key);
...
class ComingSoon extends StatelessWidget {
  final List upComing;
  final String name;
  const ComingSoon({Key? key, required this.upComing, required this.name})
      : super(key: key);
...
class TVShows extends StatelessWidget {
  final List tvShows;
  final String name;
  const TVShows({Key? key, required this.tvShows, required this.name})
      : super(key: key);
